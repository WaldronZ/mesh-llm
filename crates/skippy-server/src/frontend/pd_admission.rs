...
mod tests {
    ...
    fn policy_flags_require_pd_serving_mvp() {
        let args = ServeOpenAiArgs {
            ...
            pd_streaming_kv_handoff: false,
            pd_stream_control_addr: None,
            pd_stream_page_addr: None,
            pd_stream_max_in_flight_chunks: 2,
            pd_stream_max_in_flight_bytes: 536_870_912,
            pd_stream_max_frame_bytes: 67_108_864,
            pd_stream_max_queue_depth: 4,
